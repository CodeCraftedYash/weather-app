...
function WeatherDataLayout() {
  ...
  return (
    <div className="w-[90%] min-h-[41dvh] lg:min-h-[25dvh] lg:w-[60%] p-2 bg-linear-90 from-blue-600 via-blue-400 to-blue-300 border-4 rounded-xl flex flex-col gap-2 font-bold m-auto relative lg:mr-2">
